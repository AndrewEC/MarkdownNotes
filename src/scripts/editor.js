class Editor {
     ...
     * been saved.
     * 
     * This will trigger an "auto save". This doesn't actually save the
     * changes to file but stores the state of the page in a temporary array.
     * This way the user can continue editing the page from where they left
     * off if they navigate away from the page without saving their changes.
     */
    ...
    /**
     * Removes the element generated by EasyMDE. This is needed to allow the
     * page to remove these elements before saving to prevent an issue where saving
     * and loading the page repeatedly will cause EasyMDE to create copies of the
     * elements causing the page size to expand infinitely.
     */
    removeEditor() {
    ...
    editPage() {
        ...
        // Initialize the EasyMDE editor if it has not yet been initialized.
        if (!this.#isInitialized()) {
